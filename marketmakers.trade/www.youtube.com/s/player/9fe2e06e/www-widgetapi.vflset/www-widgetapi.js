    ...
    r("Promise", function(a) {
        ...
        b.all = function(h) {
            ...
            return k.done ? d([]) : new b(function(l, m) {
                ...
                var w = [],
                    A = 0;
                do w.push(void 0), A++, d(k.value).B(u(w.length - 1), m), k = g.next(); while (!k.done)
            })
        };
        return b
    });
    ...
    function Hb(a, b, c) {
        Z || (Z = {}, Lb = new Set, Nb.addEventListener("message", function(d) {
            a: if (Lb.has(d.origin)) {
                ...
                var e = Z[f.id];
                if (e && d.origin === e.O) switch (d = e.U, d.m = !0, d.m && (va(d.l, d.sendMessage, d), d.l.length = 0), e = f.event, f = f.info, e) {
                    ...
                    case "initialDelivery":
                        H(f) && (clearInterval(d.h), d.playerInfo = {}, d.v = {}, Kb(d, f.apiInterface), Jb(d, f));
                        break;
                    default:
                        d.j.i ||
                            (h = {
